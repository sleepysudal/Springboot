...
<input type="hidden" name="num" value="${dto.num }">
	<table class="table table-striped" style="width:1000px;">
		...
		<tr>
			<th>상품명</th>
			<td>
			<input type="text" name="sang" required="required" class="form-control" style="width:100px;" value="${dto.sang }">
			</td>
		</tr>
		<tr>
			<th>상품사진</th>
		...
		<tr>
			<th>가격</th>
			<td>
			<input type="text" name="price" required="required" class="form-control" style="width:100px;" value="${dto.price }">
			</td>
		</tr>
